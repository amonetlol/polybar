...
ICONS_REPO="https://github.com/archcraft-os/archcraft-cursors.git"
ICONS_DIR="$HOME/.src/archcraft-cursors"
...
if [ ! -d "$DEST_DIR" ]; then
    mkdir "$DEST_DIR"
    echo "Diretório $DEST_DIR criado."
else
...
chmod -R a+r $HOME/.local/share/icons
...
# chown -R seu_usuario:seu_usuario /usr/share/icons
